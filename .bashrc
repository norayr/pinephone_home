...
#alias vimdebug="vim -V9vimlog.txt"
# 2fa
# usage
...
alias arnetik="ssh -p2323 root@arnet.am"
alias sdf="ssh tanakian@sdf.org"
...
#weather
alias weather="curl -s https://wttr.in/Yerevan | head -n -1"
...
alias eworld2="doas emerge --deep --update --newuse --changed-use --with-bdeps=y --autounmask --autounmask-write @world"
alias eworld3="doas emerge --newuse --update --ask --backtrack=9999 --deep --with-bdeps=y --regex-search-auto=y --verbose @world"
...
alias bchromi='chromium --alsa-output-device=bluealsa'
alias bmplayer='mplayer -ao alsa:device=bluealsa'
alias sda1='doas mount /dev/sda1 /mnt/floppy -o uid=5555,gid=5555'
alias sdb1='doas mount /dev/sdb1 /mnt/floppy -o uid=5555,gid=5555'
...
alias mars="doas screen /dev/ttyUSB1  115200"
...
# invert screen
alias rotate="xrandr --output eDP1 --rotate inverted"
alias rotateback="xrandr --output eDP1 --rotate normal"
alias rleft="xrandr --output eDP1 --rotate left"
alias rright="xrandr --output eDP1 --rotate right"
alias rnormal="xrandr --output eDP1 --rotate normal"
...
# doas apt install i2c-tools¶

## Turn LED on in torch mode¶
alias ton="doas i2cset -y 2 0x53 0x10 0x1a"¶

## Turn LED on in privacy indication mode¶
alias tonp="doas i2cset -y 2 0x53 0x10 0x19"¶

## Turn LED off (in any mode)¶
alias toff="doas i2cset -y 2 0x53 0x10 0x18"¶

## Use LED for doing a hella bright flash for some time once and then turn off¶
alias tonn="doas i2cset -y 2 0x53 0x10 0x1b"
...
# Map Ctrl+e to the next command in history
bind '"\C-e":next-history'

# Map Ctrl+y to the previous command in history
#bind '"\C-y":previous-history'
bind '"\ep": previous-history'
alias type="xdotool type --delay 100 "
alias lsattributes="getfattr -d"
alias am='setxkbmap "us(dvp), am" -option "esperanto:dvorak,grp:lalt_lshift_toggle,lv3:win_switch"'
